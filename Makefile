...
TRAFF_GEN_FILES = debug.c debug.h traff_gen.h tpl.c tpl.h util.c http_parser.c http_parser.h udp_util.c udp_util.h tcp_util.c tcp_util.h 
...
client: client.c $(TRAFF_GEN_FILES)
	$(CC) $(CC_OPTS) -g -o $@ util.c client.c debug.c tpl.c http_parser.c udp_util.c tcp_util.c $(CC_LIBS) 
